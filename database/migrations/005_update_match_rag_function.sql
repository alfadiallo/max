-- 005_update_match_rag_function.sql
-- Align match_rag_content signature with Supabase RPC parameter order

begin;

drop function if exists public.match_rag_content(vector, integer, double precision);
