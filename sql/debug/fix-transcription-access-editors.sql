-- =====================================================
-- Fix Transcription Access for Editors - SIMPLE VERSION
-- =====================================================
...
-- =====================================================
-- SIMPLIFIED: Drop and recreate max_transcriptions SELECT policy
-- =====================================================
...
-- Create a simple, clear policy for SELECT
...
-- Keep INSERT policy
DROP POLICY IF EXISTS "Allow users to create transcriptions" ON max_transcriptions;
...
-- =====================================================
-- SIMPLIFIED: Drop and recreate max_transcription_versions SELECT policy
-- =====================================================
...
-- =====================================================
-- Verify policies exist and show their logic
-- =====================================================
